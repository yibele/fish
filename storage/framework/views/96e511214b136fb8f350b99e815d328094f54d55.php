 <?php $__env->startSection('content'); ?>
    ...
    <div class="container1" id="postCard" style="">
                ...
                <?php $__currentLoopData = $fonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="fonts">
                        <?php $__currentLoopData = $f; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="fonts_lt">
                                <img src="/img/fonts/<?php echo e($font['imgSrc']); ?>" alt="<?php echo e($font['fname']); ?>" class='font_img'
                                     onclick='changeFontFamily(event,"<?php echo e($font['fname']); ?>","<?php echo e($font['accesskey']); ?>","<?php echo e($font['lineHeight']); ?>");'>
                            </div>
        ...
        <div class="letter_img_lt" id="A" v-show="postcard_step ==1">
            ...
            <div class="" id="colors">
                ...
                <?php $__currentLoopData = $fontColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="postcard_color" style="background-color: <?php echo e($color['value']); ?>"></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="btn_rt">
        ...
        <div class="postcard_menu menu_active" id="cantpostcard">
            ...
            <?php $__currentLoopData = $cantPostCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="postcard_menu_detail">
                    <?php $__currentLoopData = $p; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img class="postcard_tums" src="<?php echo e(asset($post['image_tum'])); ?>" alt=""
                             onclick="changePostCardBackground(event,<?php echo e($post['id']); ?>)"/> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="postcard_content_cant postcard_content_active" id="postcard_content_cant">
            <div class="postcard_buke_background_img" id="postcard_buke_background_img"
                 ...
                 style="background-image:url(<?php echo e(asset('img/cantpostcard/images/mxp_1.jpg')); ?>)">
            </div>
        ...
        <div class="postcard_buke_background_content" id="postcard_buke_background_content">
            <div class="buke_stamp" id="buke_stamp"  style="background-image: url(<?php echo e(asset('img/postcard/addstamp.png')); ?>)
            "  >

        <img class="delete_icon1" src="<?php echo e(asset('img/postcard/delete.png')); ?>" alt="">
        <img class="expand1" src="<?php echo e(asset('img/postcard/expand.png')); ?>" alt="">
        </div>
        <div class="buke_postcard_text" id="buke_postcard_text" v-on:click="postCardShowEditFont">
            <div contenteditable="true">亲爱的__:</div>
            <img src="<?php echo e(asset('img/postcard/expand.png')); ?>" class="expand" alt="">
            <img src="<?php echo e(asset('img/postcard/delete.png')); ?>" class="delete_icon" alt="">
        </div>
...
<?php $__env->stopSection(); ?> <?php $__env->startPush('javascript'); ?>
<script src="js/colorpicker.js"></script>
<script src="js/jquery.slides.min.js"></script>
<script src='js/jquery-ui.min.js'></script>
<script src="<?php echo e(asset('js/postcard.js')); ?>"></script>
<?php $__env->stopPush(); ?>
