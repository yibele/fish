...
<div class="modal" id="loginModal">
    ...
    <div class="modal-content" style="background-image:url('<?php echo e(asset('img/index/loginBack.png')); ?>');width:670px;height : 380px">
        ...
        <div class="is-centered loginForm is-active" id="loginForm">
            <form action="<?php echo e(url('/login')); ?>" method="post" style="margin-top:40px;width:420px" id="lForm" >
        ...
        <div class="is-centered loginForm" id="registerForm">
            <form action="<?php echo e(url('/register')); ?>" method="post" style="margin-top:40px;width:420px" id="register-form">
                <?php echo e(csrf_field()); ?>
