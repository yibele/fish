        ...
        <div class='charges_content'>
            <div class='charges_col1'>
                <div class='charges_detail'>
                    <h4>
                        <img src="{{asset('img/charges/charges_icon_03.png')}}" class="charges_icon" alt="">
                        慢递鱼是什么?</h4>
                ...
                <div class='charges_detail'>
                    <h4>
                        <img src="{{asset('img/charges/charges_icon_03.png')}}" alt="" class="charges_icon">
                        资费是多少，怎样邮寄?
                    </h4>
            ...
            <div class='charges_col2'>
                ...
                <p>客服邮件: {{ $kefu->email }}</p>
                <p>意见建议: {{ $kefu->email2 }}</p>
                <p>微信公众号: {{ $kefu->wechat }}</p>
                <img src="{{asset('img/index/erweima_07.png')}}" style="margin-top:40px" alt="">
            </div>
        </div>
@endsection
