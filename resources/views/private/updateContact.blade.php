    ...
    <div class="container1">
        <div class="contact_container">
            <div class="contact_main">
                <div style="float:right ;">
                    收件人 1
                    <p style="cursor:pointer;text-decoration: underline">删除</p>
                </div>
                <form action="">
                    <div style="margin-bottom:10px;">
                    <p style="margin-top:10px;">请选择寄信日期:  &nbsp&nbsp</p>
                        <input type="text" class="contact_input contact_input1" id="yesr">年 &nbsp&nbsp&nbsp&nbsp&nbsp<input style="width:100px" class=" contact_input1 contact_input" type="text" id="month"> 月&nbsp&nbsp&nbsp&nbsp&nbsp   <input type="text" id="day" class="contact_input contact_input1" style="width : 90px;">日
                    <br>
                    </div>
                    <div >
                        ...
                        <nav class="pagination" role="navigation" aria-label="pagination" style="display:inline-block;width:400px;float:right;margin-top:10px">
                            <a href="#" class="pagination-previous pagination-border-reset" >上一页</a>
                                <ul class="pagination-list" style="display:inline-block">
                                    <li>
                                        <a href="" class="pagination-link pagination-border-reset">1</a>
                                        <a href="" class="pagination-link pagination-border-reset">2</a>
        ...
        <a href="#" style="margin-top:10px;display:block;margin-left:5px;" class='reset_a' > <span>>></span> 保存到草稿箱</a>
            <div style="text-align:center">
                ...
                <button class="btn1" style="display:inline-block;font-size:15px">下一步：在线支付</button>
            </div>
    </div>
